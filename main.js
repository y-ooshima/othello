...
let white_cnt = 2
let black_cnt = 2
let tarn_black_cnt = document.getElementById('view_black_cnt')
tarn_black_cnt.textContent = "● 黒：" + black_cnt
let tarn_white_cnt = document.getElementById('view_white_cnt')
tarn_white_cnt.textContent = "◯ 白：" + white_cnt
...
function cheng_turn () {
    ...
    switch( turn ) {
        ...
        break;
        case 3:
        tarn_msg.textContent = "白の勝ちです";
        break;
        case 4:
        tarn_msg.textContent = "黒の勝ちです";
        break;
    }
    //現在数の表示
    tarn_black_cnt.textContent = "● 黒：" + black_cnt
